                        ...
                        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                            ...
                            <div>
                                <div className="lg:w-[570px]">
                                    ...
                                    md:leading-[70px] ">We help patients live  healthy, longer life.
                                    </h1>
                                    <p className="text__para">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore necessitatibus inventore,
                                        placeat, nisi ducimus facere earum deleniti nemo, ut enim fugit nostrum quidem eos nesciunt
                                        illum facilis asperiores fuga reiciendis.
                                    </p>
                ...
                <section>
                    <div className="container">
                        <div className="xl:w-[470px] mx-auto  ">
                            ...
                            <p className="text__para text-center">
                                World-Class care for everyone. Our medical system offers unmatched,
                                expert health care.
                            </p>
                        </div>
                        <ServiceList />
                        ...
                        <div className="xl:w-[670px]">
                            ...
                            <ul className="pl-4">
                                <li className="text__para">
                                    1.Schedule the appointment ditrectly.
                                </li>
                                <li className="text__para">
